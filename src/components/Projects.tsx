...
export const Projects: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="p-16 border border-gray-200/60 rounded-3xl flex flex-col items-center justify-center bg-white shadow-sm relative overflow-hidden group">
        ...
        <p className="font-mono text-sm text-gray-400 tracking-widest uppercase mt-4">{t.comingSoon}</p>
      </div>
    </motion.section>
  );
};
