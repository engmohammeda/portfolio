...
export const About: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-2xl sm:text-3xl lg:text-4xl text-black dark:text-white leading-snug tracking-tight font-medium space-y-8 max-w-3xl">
        <p>{t.p1}</p>
        <p className="text-gray-400 dark:text-gray-500">{t.p2}</p>
      </div>
    </motion.section>
  );
};
