          ...
          <div className="lg:order-1 order-2 space-y-8">
            ...
            <div className="space-y-4 animate-float" style={{animationDelay: '0.3s'}}>
              ...
              <div className="flex flex-wrap gap-2">
                {['Total Station', 'Civil 3D', 'AutoCAD', 'GPS/GNSS', 'Python'].map((skill, index) => (
                  <span 
                    key={skill} 
            ...
            <div className="flex gap-4 mt-8">
              <Button 
                ...
                onClick={() => window.open('https://github.com/engmohammeda', '_blank')}
              >
              ...
              <Button 
                ...
                size="icon" 
                className="hover:bg-primary/10 border-primary/20"
                onClick={() => window.open('https://www.linkedin.com/in/mohammed-albukhaiti-308b9937b?trk=contact-info', '_blank')}
              >
              ...
              <Button 
                ...
                size="icon" 
                className="hover:bg-primary/10 border-primary/20"
                onClick={() => window.open('https://twitter.com/engalbukhaiti', '_blank')}
              >
              ...
              <Button 
                ...
                size="icon" 
                className="hover:bg-primary/10 border-primary/20"
                onClick={() => window.open('mailto:Mohammedlbkhyty@gmail.com', '_blank')}
              >
              ...
              <Button 
                ...
                size="icon" 
                className="hover:bg-primary/10 border-primary/20"
                onClick={() => window.open('https://wa.me/967714403583', '_blank')}
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="relative group">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-6 -right-6 bg-card/80 backdrop-blur-sm border border-primary/30 rounded-xl p-3 animate-float" style={{animationDelay: '1s'}}>
                  <div className="text-primary font-bold text-lg">3km</div>
                  <div className="text-xs text-muted-foreground">طريق جبلي</div>
                </div>
                ...
                <div className="absolute -bottom-6 -left-6 bg-card/80 backdrop-blur-sm border border-secondary/30 rounded-xl p-3 animate-float" style={{animationDelay: '1.5s'}}>
                  <div className="text-secondary font-bold text-lg">2025</div>
                  <div className="text-xs text-muted-foreground">دبلوم</div>
                </div>
              </div>
            </div>
          </div>
